 ...
 */
class Channel(val id: String, val name: String, private val users: HashMap<String, String>, private val messages: HashMap<String, Message>, val picture: String? = null) : Parcelable {
